...
fun booksItemAdapterDelegate(onNestedClick: (String) -> Unit): AdapterDelegate<List<BaseItem>> {
    return adapterDelegateViewBinding<BooksUi, BaseItem, ItemBooksBinding>(viewBinding = { layoutInflater, parent ->
